...
const Header = ({ type }) => {
  ...
  const{dispatch,info}=useContext(contextProvider)

  const handleSearch = () => {
    navigate("/hotels", { state: { destination, dates, options } });
    dispatch({type:'new action',payload:{destination,
       dates,
     options }})
  };
      ...
      >
        ...
        {type !== "list" && (
          <>
            ...
            {!userAuth?.id&&<button className="headerBtn">Sign in / Register</button>}
